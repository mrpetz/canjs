...
System.bundles = {"bundles/bit-docs-site/static.css!":["bit-docs-html-canjs@0.4.5#static/canjs.less!$less","bit-docs-prettify@0.1.0#prettify.less!$less","bit-docs-site@0.0.1#styles/styles.less!$less"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    (function (loader, packages, options) {
        ...
        },
        {
            ...
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-html-canjs': '0.4.5' }
        },
        {
            ...
            'main': 'prettify.js',
            'system': { 'meta': { 'bit-docs-prettify@0.1.0#prettify-engine': { 'format': 'global' } } },
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-prettify': '0.1.0' }
        },
        {
...
/*bit-docs-html-canjs@0.4.5#static/canjs*/
define('bit-docs-html-canjs@0.4.5#static/canjs', function (require, exports, module) {
    require('./canjs.less!');
    $ = require('jquery');
    var $articleContainer, $onThisPage, $tableOfContents, $onThisPageTitle, $everything, $headers, $nav, headerHidden, animating, navigating, scrollPositionInterval;
    setState();
    ...
    function toggleNav(hide) {
        ...
        var breakpoint = 20, headerHeight = 53;
    ...
    function buildTOC() {
        ...
        var level = 0, baseLevel = $tocHeaders[0].nodeName.substr(1), toc = '<ol>';
...
/*bit-docs-prettify@0.1.0#prettify-engine*/
define('bit-docs-prettify@0.1.0#prettify-engine', [
    'module',
    '@loader'
...
/*bit-docs-prettify@0.1.0#prettify*/
define('bit-docs-prettify@0.1.0#prettify', function (require, exports, module) {
...
/*bit-docs-html-highlight-line@0.2.3#highlight-line*/
define('bit-docs-html-highlight-line@0.2.3#highlight-line', function (require, exports, module) {
    var $ = require('jquery');
    var getLines = function (lineString) {
        ...
        for (var i = 0; i < lineArray.length; i++) {
            var val = lineArray[i];
            if (/^([\d]+-[\d]+)$/.test(val)) {
                var values = val.split('-'), start = values[0] - 1, finish = values[1] - 1;
...
define('bit-docs-site@0.0.1#packages', function (require, exports, module) {
    ...
    module.exports = {
        'bit-docs-html-canjs': callIfFunction(require('bit-docs-html-canjs')),
